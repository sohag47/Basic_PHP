        ...
        <div class="row justify-content-center baselink">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    $sql = "SELECT * FROM twitch_user_info";
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='userdetails.php?id=". $row['id'] ."' title='View Record' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
